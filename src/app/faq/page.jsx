...
const FAQ_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: '증권 계좌도 통합조회로 확인할 수 있나요?',
        a: '금융감독원 상속인 금융거래 통합조회를 통해 증권사 계좌의 존재 여부(유·무)는 확인할 수 있습니다. 하지만 계좌 잔액이나 보유 종목 등 세부 내역은 조회 결과에 포함되지 않습니다. 정확한 잔액과 내역을 확인하려면 해당 증권사 지점을 직접 방문해야 하며, 방문 시 사망진단서 원본·가족관계증명서·상속인 신분증을 지참하셔야 합니다. 증권사마다 절차가 조금씩 다를 수 있으니 방문 전 고객센터에 먼저 확인하시길 권장합니다.',
        highlight: true,
      },
      {
